<template>
  <div class="plan-area">
    <v-container>
      <v-row>
        <v-col>
          <h1 class="text-center">Upload workout/meal plan's</h1>
        </v-col>
      </v-row>
      ...
      <v-row>
        <v-col md="12" xs="12">
          <div class="plan-form">
            <p class="text-center">
              The service offers the facility to propose for purchase - the books, which are necessary for your
              activity,
            ...
            <v-form
              ...
              <v-text-field
                  ...
                  dense outlined
                  :rules="nameRules"
                  label="Workout/meal plan's Name"
                  required
              ></v-text-field>

              <v-text-field label="Workout/meal plan's Price" dense outlined></v-text-field>
              ...
              <v-textarea
                  ...
                  name="input-7-4"
                  label="Workout/meal plan's Description"
                  hint="Hint text"
              ></v-textarea>
              ...
              <v-text-field label="Workout/meal plan's Equipment Required" dense outlined></v-text-field>
              <v-text-field label="Workout/meal plan's Equipment Recommended" dense outlined></v-text-field>


              <v-text-field label="Facebook" dense outlined></v-text-field>
              <v-text-field label="Instagram" dense outlined></v-text-field>
              <v-text-field label="Twitter" dense outlined></v-text-field>
              <v-text-field label="Youtube" dense outlined></v-text-field>
              <v-text-field label="Name (link)" dense outlined></v-text-field>
              <v-text-field label="Coach fields of activity" dense outlined></v-text-field>
              <v-text-field label="Coach wallet" dense outlined></v-text-field>
