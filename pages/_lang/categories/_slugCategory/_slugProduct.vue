<template>
  ...
  <div class="product-page-area">
    <img src="/img/pasted image 0.png" alt="" class="banner-image">
...
<!--          <img src="/img/unsplash_F56Y7dgrAkc.png" alt="" class="main-product-image">-->
        ...
        <v-col md="7" xs="12" class="product-details">
          ...
          <div class="rating">
            <span class="score" style="--_score:90%"></span>
      ...
      <v-row>
        <v-col class="mt-8">
          <iframe width="100%" height="515" src="https://www.youtube.com/embed/o61dLV9ccXA" title="YouTube video player"
                  frameborder="0"
  ...
  <!--                  {{ parsePrice(thing) }}-->
  <!--                  &lt;!&ndash;                  {{ product.personal_price.price }}&ndash;&gt;-->
  <!--                  &lt;!&ndash;                  <span v-if="product.personal_price.old_price > product.personal_price.price">/</span>&ndash;&gt;-->
  <!--                  &lt;!&ndash;                  <span class="price__discount" v-if="product.personal_price.old_price > product.personal_price.price">&ndash;&gt;-->
  <!--                  &lt;!&ndash;                  {{ product.personal_price.old_price }}&ndash;&gt;-->
  <!--                  &lt;!&ndash;                </span>&ndash;&gt;-->
  <!--                  {{ currency.abbr }}-->
  <!--                </p>-->

  <!--                &lt;!&ndash;                <near-buy></near-buy>&ndash;&gt;-->

  <!--                &lt;!&ndash;                <v-btn outlined color="primary"&ndash;&gt;-->
  <!--                &lt;!&ndash;                       :href="`https://www.mintbase.io/meta/${mainnnetId}/auction?tokenId=21`"&ndash;&gt;-->
  <!--                &lt;!&ndash;                       target="_blank"&ndash;&gt;-->
  <!--                &lt;!&ndash;                       class="mr-20">&ndash;&gt;-->
  <!--                &lt;!&ndash;                  <v-icon>mdi-label</v-icon>&ndash;&gt;-->
  <!--                &lt;!&ndash;                  Make Offer&ndash;&gt;-->
  <!--                &lt;!&ndash;                </v-btn>&ndash;&gt;-->
  ...
  <!--                &lt;!&ndash;                <sizes :product="product" v-if="product.subproducts.length"/>&ndash;&gt;-->
  <!--                &lt;!&ndash;                <div class="mt-4" v-else>&ndash;&gt;-->
  <!--                &lt;!&ndash;                  <near-buy-sub-product-btn :product="product"></near-buy-sub-product-btn>&ndash;&gt;-->
  <!--                &lt;!&ndash;                </div>&ndash;&gt;-->
  ...
  <!--                  &lt;!&ndash;                  <v-expansion-panel v-if="offers.length">&ndash;&gt;-->
  <!--                  &lt;!&ndash;                    <v-expansion-panel-header>Offers</v-expansion-panel-header>&ndash;&gt;-->
  <!--                  &lt;!&ndash;                    <v-expansion-panel-content>&ndash;&gt;-->
  <!--                  &lt;!&ndash;                      <offers-area :offers="offers" v-if="offers.length"></offers-area>&ndash;&gt;-->
  <!--                  &lt;!&ndash;                    </v-expansion-panel-content>&ndash;&gt;-->
